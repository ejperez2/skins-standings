...
df_final_projections <- all_teams %>%
  ...
  mutate(
    ...
    weighted_average = if_else(
      ...
      (vegas_consensus * 0.20) + (tr_skins * 0.30) + (espn_skins * 0.20) + (cbs_skins * 0.10) + (br_skins * 0.20),
      (tr_skins * 0.35) + (espn_skins * 0.25) + (cbs_skins * 0.10) + (br_skins * 0.30)  # Fallback formula without Vegas
    ),
