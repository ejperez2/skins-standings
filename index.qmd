...
kable(player_scores_display, caption = "Total Player Scores: Actual and Projected", align = c("l", "r", "r", "r", "r", "r", "r", "r", "r")) %>%
...
kable(
  ...
  column_spec(6, bold = TRUE, background = "#FFF9C4") %>%  # Highlight skins %
  column_spec(8, bold = TRUE, background = "#DFF0D8") %>%  # Highlight weighted average
...
kable(team_projections_table, caption = "Live Skins Projections by Team", align = c("l", "c", "r", "r", "r", "r", "r", "r", "r")) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"), full_width = FALSE, position = "center") %>%
  row_spec(0, bold = TRUE, color = "white", background = "#444444") %>%
  column_spec(1, bold = TRUE) %>%
