...
df_final_projections <- all_teams %>%
  ...
  mutate(
    ...
    weighted_average = 
      (tr_skins * 0.65) + (espn_skins * 0.15) + (cbs_skins * 0.20) ,  # Fallback formula without Vegas
...
cat("<p style='font-size: 13px; margin-top: 2px; margin-bottom: 0; text-align: left;'>Feb Weighted Avg: TR 65%, ESPN 15%, CBS 20% (Last season's most accurate post-ASB Feb weightings)</p>")
```
