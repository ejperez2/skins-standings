...
player_scores <- draft_data %>%
  ...
  mutate(`Proj Avg` = rowMeans(select(., `Weighted Average`, `Vegas Consensus`, `TR`, `ESPN`, `CBS`, `BB-Ref`))) %>%
...
# Add column names with hyperlinks
col_names <- c("Player", "Actual Skins", "Skins %", "% Projected", "Weighted Average", 
               "Vegas Consensus", 
               "<a href='https://www.teamrankings.com/nba/projections/standings/' target='_blank'>TR</a>",
               "<a href='https://www.espn.com/nba/bpi/_/view/projections' target='_blank'>ESPN</a>",
               "<a href='https://www.cbssports.com/nba/standings/' target='_blank'>CBS</a>",
               "<a href='https://www.basketball-reference.com/friv/playoff_prob.html' target='_blank'>BB-Ref</a>",
               "Proj Avg", "Max Proj")

kable(player_scores_with_avg, align = c("l", "r", "r", "r", "r", "r", "r", "r", "r", "r", "r", "r", "r"),
...
standings_table <- draft_data %>%
  ...
  rowwise() %>%
  mutate(
    `Proj Avg` = mean(c(`Weighted Average`, `Vegas Consensus`, `TR`, `ESPN`, `CBS`, `BB-Ref`), na.rm = TRUE)
  ) %>%
  ungroup() %>%
  select(
    team,
...
# Column names with hyperlinks for by-player tables
...
team_projections_table <- df_final_projections %>%
  ...
  rowwise() %>%
  mutate(
    `Proj Avg` = mean(c(weighted_average, vegas_consensus, tr_skins, espn_skins, cbs_skins, br_skins), na.rm = TRUE)
  ) %>%
  ungroup() %>%
  select(
    Team = team,
...
# Column names with hyperlinks for team table
...
kable(team_projections_table, align = c("l", "l", "c", "r", "r", "r", "r", "r", "r", "r", "r", "r", "r", "r"),
