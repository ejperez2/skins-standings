...
df_final_projections <- all_teams %>%
  ...
  mutate(
    ...
    weighted_average = 
      (tr_skins * 0.28) + (espn_skins * 0.68) + (cbs_skins * 0.04) ,  # Fallback formula without Vegas
...
cat("<p style='font-size: 13px; margin-top: 2px; margin-bottom: 0; text-align: left;'>April Weighted Avg: TR 28%, ESPN 68%, CBS 4% (Last season's most accurate April weightings)</p>")
