...
df_final_projections <- all_teams %>%
  ...
  mutate(
    ...
    weighted_average = 
      (tr_skins * 0.37) + (espn_skins * 0.58) + (cbs_skins * 0.05) ,  # Fallback formula without Vegas
...
cat("<p style='font-size: 13px; margin-top: 2px; margin-bottom: 0; text-align: left;'>March Weighted Avg: TR 37%, ESPN 58%, CBS 5% (Last season's most accurate March weightings)</p>")
cat("<p style='font-size: 13px; margin-top: 2px; margin-bottom: 0; text-align: left;'>*No betting markets for ~10 tanking teams since ASB </p>")
```
