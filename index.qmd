...
df_final_projections <- all_teams %>%
  ...
  mutate(
    ...
    weighted_average = 
      (tr_skins * 0.48) + (espn_skins * 0.20) + (cbs_skins * 0.32) ,  # Fallback formula without Vegas
...
cat("<p style='font-size: 13px; margin-top: 2px; margin-bottom: 0; text-align: left;'>Feb Weighted Avg: TR 48%, ESPN 20%, CBS 32% (Last season's most accurate pre-ASB Feb weightings)</p>")
```
