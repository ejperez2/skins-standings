...
df_final_projections <- all_teams %>%
  ...
  mutate(
    ...
    weighted_average = 
      (tr_skins * 0.5) + (espn_skins * 0.34) + (cbs_skins * 0.16) ,  # Fallback formula without Vegas
...
cat("<p style='font-size: 13px; margin-top: 2px; margin-bottom: 0; text-align: left;'>Winner's Skins 2023-25: <b>249, 280, 260</b></p>")
cat("<p style='font-size: 13px; margin-top: 2px; margin-bottom: 0; text-align: left;'>November Weighted Avg: TR 50%, ESPN 34%, CBS 16% (Last season's most accurate Nov weightings)</p>")
```
